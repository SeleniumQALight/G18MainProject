...
public class AddNewApparatWithDataFromExcel {
    ...
    public AddNewApparatWithDataFromExcel(String apparatNumber, String apparatComment) {
        super();
...
//    }
    ...
    public static Collection testdata() throws IOException {
        ...
        return new SpreadsheetData(spreadsheet, "TestLoginPageNotValidWithPO").getData();
    }
